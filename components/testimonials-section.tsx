  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        ...
        <p className="text-foreground/55 text-lg">Plus de 28 000 clientes font confiance à Glow Beauty.</p>
      </motion.div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {TESTIMONIALS.map(({ name, handle, avatar, text, rating, product }, i) => (
          <motion.div
            ...
            whileHover={{ y: -5 }}
            className="glass-card rounded-3xl p-6 relative flex flex-col gap-4"
          >
            ...
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl overflow-hidden flex-shrink-0 border-2 border-white/40 dark:border-white/10">
            ...
            <div className="flex items-center gap-1.5">
              <span className="text-[10px] badge-glass px-2.5 py-1 rounded-full text-foreground/50 font-medium">
                {product}
              </span>
            </div>
          </motion.div>
