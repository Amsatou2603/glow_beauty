        ...
        try:
            ...
            for product_data in sample_products:
                try:
                    ...
                    self.stderr.write(f'Error creating product {product_data.get("name")}: {str(e)}')
            ...
            self.stderr.write(self.style.ERROR(f'Failed to seed products: {str(e)}'))
            logger.error(f'Seed products failed: {str(e)}')
            raise
